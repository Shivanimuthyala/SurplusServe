...
const fitForConsumptionSchema = new mongoose.Schema({
  donorName: String,
  phoneNumber: String,
  location:String,
  foodType: String,
...
fitForConsumptionSchema.pre('save', function (next) {
...
module.exports = mongoose.model('FitForConsumption', fitForConsumptionSchema);
